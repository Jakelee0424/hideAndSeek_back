...
final class Interactables {
    ...
    private static final List<Poi> ALL = List.of(
            ...
            //
            // 봇이 순회할 쪽지: 해독 조각 문서 3곳(식당·수감동 복도·연병장 — 본문은 프론트가
            // 방 시드로 생성한다. escapePlan.ts / EscapePlan.java) + 별관 복도의 방 자물쇠
            // 힌트 쪽지(항상 열린 복도라 봇이 닿는다). 잠긴 방 "안"의 쪽지는 넣지 않는다 —
            // 넣으면 봇이 닫힌 문 앞으로 걸어가 멈춘다(감방 자물쇠와 같은 함정).
            new Poi("doc-cafe", 14, 24, false, false, "배식표 낙서(식당)"),
            new Poi("doc-hall", -26, 15, false, false, "벽 긁힌 흔적(수감동 복도)"),
            new Poi("doc-yard", -34, -27.5, false, false, "모래 글씨(연병장 구석)"),
